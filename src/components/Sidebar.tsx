...
export function Sidebar() {
  ...
  return (
    <>
      {/* Horizontal Navbar - Visible on mobile/tablet (md and below) */}
      <nav className="lg:hidden fixed top-0 left-0 right-0 w-full px-4 md:px-6 py-3 md:py-4 bg-white dark:bg-slate-950 border-b border-slate-300 dark:border-slate-700 z-50">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <SignedOut>
              <SignInButton>
                <button className="px-2 md:px-3 py-1 bg-slate-900 dark:bg-slate-50 text-slate-50 dark:text-slate-900 font-semibold tracking-widest text-xs uppercase rounded border border-slate-900 dark:border-slate-50 hover:opacity-80">
                  Sign In
                </button>
              </SignInButton>
            </SignedOut>
      ...
      {/* Vertical Sidebar - Visible on large screens (lg and above) */}
      <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-48 px-8 py-12 flex-col justify-between bg-white dark:bg-slate-950 border-r border-slate-300 dark:border-slate-700 z-50">
        {/* Top Navigation */}
        <div>
          {/* Logo */}
          <div className="mb-16">
